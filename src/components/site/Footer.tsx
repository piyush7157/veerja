...
export function Footer() {
  return (
    <footer id="contact" className="border-t border-border bg-brown text-primary-foreground">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-4">
        <div className="min-w-0 lg:col-span-2">
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <span className="font-display text-2xl font-semibold">Veerja Eats</span>
          </div>
            ...
            {SOCIALS.map(({ label, Icon }) => (
              <li key={label}>
                <a
                  href="#home"
                  aria-label={label}
                  className="grid h-10 w-10 place-items-center rounded-full border border-primary-foreground/20 transition-all hover:border-gold hover:bg-gold hover:text-brown"
                >
